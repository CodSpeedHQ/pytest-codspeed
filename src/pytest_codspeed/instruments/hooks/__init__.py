...
def _load_module_constant(name: str) -> int:
    from . import dist_instrument_hooks  # type: ignore

    return getattr(dist_instrument_hooks, name)


# Constants are defined in instrument-hooks/includes/core.h and re-exported
# from the native extension module (see instrument_hooks_module.c).
FEATURE_DISABLE_CALLGRIND_MARKERS = _load_module_constant(
    "FEATURE_DISABLE_CALLGRIND_MARKERS"
)
MARKER_TYPE_SAMPLE_START = _load_module_constant("MARKER_TYPE_SAMPLE_START")
MARKER_TYPE_SAMPLE_END = _load_module_constant("MARKER_TYPE_SAMPLE_END")
MARKER_TYPE_BENCHMARK_START = _load_module_constant("MARKER_TYPE_BENCHMARK_START")
MARKER_TYPE_BENCHMARK_END = _load_module_constant("MARKER_TYPE_BENCHMARK_END")
